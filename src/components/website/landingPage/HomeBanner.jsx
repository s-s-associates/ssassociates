...
//         backgroundImage:
//           "linear-gradient(145deg, #1a1f24 0%, #161b20 40%, #12161a 100%)",
//       }}
//     >
...
//         ))}
//       </Box>
//       {/* Person image as background - upper layer (on top of grid), nothing removed */}
...
//       {/* Left edge fade - above person for vignette */}
//       <Box
//         aria-hidden
//         sx={{
//           position: "absolute",
...
//         }}
//       />
//       {/* Right edge fade - above person for vignette */}
//       <Box
//         aria-hidden
//         sx={{
//           position: "absolute",
...
//       {/* Text + stats image - bottom right, above blurred section */}
//       <Box
//   sx={{
//     position: "absolute",
//     bottom: 100,
...
//       {/* Glassy blur bar at bottom - height 100px */}
//       <Box
//         sx={{
//           position: "absolute",
//           bottom: 0,
        ...
        {Array.from({ length: 200 }, (_, i) => (
          <Box
            ...
            sx={{
              ...
              "&:hover": {
                // transform: "translateY(-8px) scale(1.06)",
                backgroundColor: "rgba(251, 133, 30, 0)",
                boxShadow: `
                  0 0 0 1px ${primaryColor},
                  0 0 8px rgba(251, 134, 30, 0.35),
