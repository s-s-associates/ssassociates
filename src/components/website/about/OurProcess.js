...
const OurProcess = () => {
  ...
  useEffect(() => {
    const updateProgress = () => {
      ...
      const progress =
        section.height > 0 ? (center - section.top) / section.height : 0;
        ...
        <Box mx="auto" sx={{ maxWidth: "1200px" }}>
          ...
          <Box sx={{ textAlign: "center", mb: { xs: 6, md: 8 } }}>
            ...
            >
              ...
              >
                From consultation to ongoing support, we guide you through every
          ...
          <Box ref={timelineRef} sx={{ position: "relative" }}>
            ...
            <Grid
              ...
              spacing={{ xs: 3, md: 6 }}
              data-step="0"
              sx={{ mb: { xs: 6, md: 8 }, position: "relative", zIndex: 2 }}
            >
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true, amount: 0.2 }}
                  transition={{ duration: 0.75, ease: STEP_EASE, delay: 0.08 }}
                >
                  <Box
                    sx={{
                      position: "relative",
